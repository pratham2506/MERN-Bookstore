        ...
        <div className="fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center" onClick={onClose}>
            <div onClick={(event) => event.stopPropagation()} className="w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative">
                ...
                <h2 className="w-fit px-4 py-1 bg-red-300 rounded-lg">
                    ...
                    <div className="flex justofy-start items-center gap-x-2">
                    ...
                    <p className="my-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae odio dolor facilis quae sunt doloremque ab velit minus. Magnam unde autem, fugit possimus voluptas soluta nulla reprehenderit esse provident corrupti odio vel voluptatibus sunt nemo commodi aperiam, accusantium recusandae labore voluptates beatae et! Nesciunt porro soluta, nemo reprehenderit repellendus dolor.</p>
            </div>
        </div>
    )
}
